...
COGNITIVE_OPERATION_FIELDS = {
    ...
    "approved_structural_analogy_exploration": (
        "shared_structure",
        "source_domain_interpretation",
        "target_domain_interpretation",
        "possible_implication",
        "failure_boundary",
        "uncertainty",
        "evidence_still_missing",
    ...
    "formulate_experiment_candidate": (
        "experiment_id",
        "title",
        "practical_objective",
        "why_it_is_useful",
    ...
    "select_goal_oriented_experiment_set": ("selected", "ranking", "rationale", "uncertainty", "recommended_state_transition"),
...
COGNITIVE_OPERATION_ENUM_FIELDS = {
    ...
    "select_goal_oriented_experiment_set": {
        "recommended_state_transition": ("select_experiment_set", "request_operator_resolution"),
    },
