...
from environment.policy_matrix import sample_action
...
class EnvironmentRuntimeLoop:
    ...
    def run_episode(self, initial_state: WorldState):
        ...
        while not state.is_terminal():
            ...
            # --------------------------------------------------
            # 7. Advance world state
            # --------------------------------------------------

            state = next_state

            # --------------------------------------------------
            # 8. Record transition outcome
            # --------------------------------------------------
    ...
    def select_action(self):
        """
        Selects an action using the navigation policy
        generated by the StimulusEncoder.

        Falls back to random exploration if no policy
        is available.
        """

        # navigation policy generated during encoding
        policy = getattr(self.runtime, "policy_bias", None)
