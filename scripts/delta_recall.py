...
def main() -> int:
    parser = argparse.ArgumentParser(description="DELTA controlled general recall trial.")
    ...
    data = write_controlled_general_recall_trial_report(query) if args.output_report else run_controlled_general_recall(query, max_candidates=args.max_candidates)
