"""DELTA post-ARC XXV Batch D: Cross Project Planning deepening module."""
...
BATCH_LABEL = "Batch D"
MODULE_SLUG = "cross_project_planning"
MODULE_ID = "deepening-d-cross_project_planning"
TITLE = "Cross Project Planning"
PURPOSE = "Deepen Cross Project Planning within Executive Deepening without activating authority."
REPORT_BASE = "runtime_deepening_d_cross_project_planning"
RECOMMENDATION = "REVIEW_DEEPENED_MODULE_BEFORE_ACTIVATION"


@dataclass(frozen=True)
class CrossProjectPlanningObject:
    object_id: str
    name: str
    purpose: str
    lifecycle_state: str
...
@dataclass(frozen=True)
class CrossProjectPlanningGraphMetadata:
    graph_id: str
...
def build_graph_export_metadata() -> CrossProjectPlanningGraphMetadata:
    ...
    return CrossProjectPlanningGraphMetadata(
