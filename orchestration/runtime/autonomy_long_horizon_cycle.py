...
def run_long_horizon_cycle(*, output_root: str | Path = AUTONOMY_12_ROOT, a11_repair_report: str | Path | None = None) -> dict[str, Any]:
    ...
    report = _digest_record({
        ...
        "selected_goal": goal,
        "ranking": {"selected_condition_key": goal["condition_key"], "automatic_policy": "bounded_no_provider_no_mutation"},
        ...
        "evaluator": {"evaluator_id": execution["evaluator"]["evaluator_id"], "evaluator_digest": execution["evaluator"]["artifact_digest"], "sealed_before_strategy": True},
