"""DELTA post-ARC XXV Batch D: Tasks deepening module."""
...
BATCH_LABEL = "Batch D"
MODULE_SLUG = "tasks"
MODULE_ID = "deepening-d-tasks"
TITLE = "Tasks"
PURPOSE = "Deepen Tasks within Executive Deepening without activating authority."
REPORT_BASE = "runtime_deepening_d_tasks"
...
def build_objects() -> tuple[TasksObject, ...]:
...
def build_graph_export_metadata() -> TasksGraphMetadata:
