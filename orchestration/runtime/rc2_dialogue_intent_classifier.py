...
RULES: tuple[DialogueRule, ...] = (
    ...
    DialogueRule("exact_acknowledgement", "acknowledgement", "acknowledgement", "brief_acknowledgement_only", 0.96, exact=("okay", "ok", "got it", "sounds good", "cool", "alright", "that makes sense", "makes sense", "no worries", "that's exactly what i wanted", "that is exactly what i wanted")),
    ...
    DialogueRule("casual_correction_meant", "correction", "correction", "revise_prior_answer_or_context", 0.91, contains_any=("not what i meant", "not what i mean", "i meant the other", "meant the other", "the other one", "not that part", "part before it", "too literally")),
    DialogueRule("casual_partial_disagreement", "correction", "correction", "revise_prior_answer_or_context", 0.89, contains_any=("i agree with most of that", "not the last part", "that's close", "thats close", "missing what i'm getting at", "missing what im getting at", "seems kinda off", "seems kind of off")),
    ...
    DialogueRule("frustration_variant", "frustration", "personal_emotion", "social_response_only", 0.86, contains_any=("this is annoying", "i'm stuck", "im stuck", "i feel lost", "frustrating", "driving me nuts", "long day", "annoyed")),
    ...
    DialogueRule("joke_variant", "joke", "conversation", "social_response_only", 0.82, contains_any=("i'm joking", "im joking", "funny", "made me laugh", "obviously computers love")),
    DialogueRule("small_talk_phrase", "small_talk", "conversation", "social_response_only", 0.86, contains_any=("how are you", "how's it going", "hows it going", "what's up", "whats up", "what are you up to")),
    DialogueRule("small_talk_variant", "small_talk", "conversation", "social_response_only", 0.84, exact=("how are things", "how do you feel", "you awake", "are you there", "how is your day", "i'm just messing around tonight", "im just messing around tonight")),
    DialogueRule("casual_acknowledgement_variant", "acknowledgement", "acknowledgement", "brief_acknowledgement_only", 0.86, contains_any=("oh, that makes sense", "oh that makes sense", "interesting", "pretty cool", "that sound right", "sounds right")),
...
def build_dialogue_intent_corpus() -> list[dict[str, Any]]:
    ...
    groups: dict[str, tuple[str, str, list[str]]] = {
        ...
        "acknowledgement": ("acknowledgement", "brief_acknowledgement_only", ["okay", "ok", "got it", "sounds good", "cool", "alright", "that makes sense", "makes sense", "no worries", "understood", "that's exactly what i wanted", "that is exactly what i wanted"]),
