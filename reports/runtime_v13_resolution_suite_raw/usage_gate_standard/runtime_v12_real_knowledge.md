...
| planning_score | `1.0` |
| hallucinations | `0.0` |
| working_memory_efficiency | `0.19` |
| planning_utilization_ratio | `0.16` |
| response_utilization_ratio | `0.16` |
| overall_utilization_ratio | `0.19` |
| average_activated_concepts | `10.0` |
| average_used_concepts | `1.9` |
| average_ignored_concepts | `8.1` |
| average_noise_concepts | `8.3` |
| average_useful_neighbors | `0.1` |
| attention_recall | `0.4333` |
| attention_precision | `0.55` |
| average_used_noise | `1.2` |
| average_ignored_noise | `7.1` |
