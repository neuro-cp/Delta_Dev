...
| planning_score | `1.0` |
| hallucinations | `0.0` |
| working_memory_efficiency | `0.2` |
| planning_utilization_ratio | `0.17` |
| response_utilization_ratio | `0.17` |
| overall_utilization_ratio | `0.2` |
| average_activated_concepts | `10.0` |
| average_used_concepts | `2.0` |
| average_ignored_concepts | `8.0` |
| average_noise_concepts | `8.3` |
| average_useful_neighbors | `0.1` |
| attention_recall | `0.4333` |
| attention_precision | `0.5` |
| average_used_noise | `1.3` |
| average_ignored_noise | `7.0` |
| average_suppressed_core | `0.9` |
| reasoning_contribution_ratio | `0.3` |
| supporting_ratio | `0.0` |
| peripheral_ratio | `0.0` |
| noise_used_in_reasoning | `13.0` |
| planning_core_coverage | `0.4333` |
| response_core_coverage | `0.4333` |
| healthy_cases | `2.0` |
| under_attending_cases | `2.0` |
| reasoning_drift_cases | `6.0` |
