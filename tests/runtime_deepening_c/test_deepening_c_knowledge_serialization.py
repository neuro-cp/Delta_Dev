...
MODULE = "orchestration.runtime.deepening_c_knowledge_serialization"
...
def test_deepening_c_knowledge_serialization_objects_validation_and_safety():
    module = m()
...
def test_deepening_c_knowledge_serialization_audit_demo_json_graph_and_report():
    module = m()
