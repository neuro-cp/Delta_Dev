...
MODULE = "orchestration.runtime.deepening_c_procedure_registry"
...
def test_deepening_c_procedure_registry_objects_validation_and_safety():
    module = m()
...
def test_deepening_c_procedure_registry_audit_demo_json_graph_and_report():
    module = m()
