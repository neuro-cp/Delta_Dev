...
MODULE = "orchestration.runtime.deepening_c_knowledge_lineage"
...
def test_deepening_c_knowledge_lineage_objects_validation_and_safety():
    module = m()
...
def test_deepening_c_knowledge_lineage_audit_demo_json_graph_and_report():
    module = m()
