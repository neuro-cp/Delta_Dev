...
MODULE = "orchestration.runtime.deepening_c_provenance_explorer"
...
def test_deepening_c_provenance_explorer_objects_validation_and_safety():
    module = m()
...
def test_deepening_c_provenance_explorer_audit_demo_json_graph_and_report():
    module = m()
