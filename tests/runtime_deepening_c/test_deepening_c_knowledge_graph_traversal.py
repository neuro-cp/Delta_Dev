...
MODULE = "orchestration.runtime.deepening_c_knowledge_graph_traversal"
...
def test_deepening_c_knowledge_graph_traversal_objects_validation_and_safety():
    module = m()
...
def test_deepening_c_knowledge_graph_traversal_audit_demo_json_graph_and_report():
    module = m()
