...
MODULE = "orchestration.runtime.deepening_c_knowledge_browser_backend"
...
def test_deepening_c_knowledge_browser_backend_objects_validation_and_safety():
    module = m()
...
def test_deepening_c_knowledge_browser_backend_audit_demo_json_graph_and_report():
    module = m()
