...
MODULE_NAME = "orchestration.runtime.arc_09_external_evidence"
...
def test_arc_09_demo_and_report_payload_json_serializable():
    m = module()
...
def test_arc_09_write_report_outputs_review_only_artifacts():
    m = module()
