...
MODULE = "orchestration.runtime.deepening_b_reflection"
...
def test_deepening_b_reflection_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_reflection_audit_demo_json_graph_and_report():
    module = m()
