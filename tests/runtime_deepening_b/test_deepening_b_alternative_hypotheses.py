...
MODULE = "orchestration.runtime.deepening_b_alternative_hypotheses"
...
def test_deepening_b_alternative_hypotheses_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_alternative_hypotheses_audit_demo_json_graph_and_report():
    module = m()
