...
MODULE = "orchestration.runtime.deepening_b_meta_reasoning"
...
def test_deepening_b_meta_reasoning_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_meta_reasoning_audit_demo_json_graph_and_report():
    module = m()
