...
MODULE = "orchestration.runtime.deepening_b_reasoning_replay"
...
def test_deepening_b_reasoning_replay_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_reasoning_replay_audit_demo_json_graph_and_report():
    module = m()
