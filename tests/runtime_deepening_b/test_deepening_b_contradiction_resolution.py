...
MODULE = "orchestration.runtime.deepening_b_contradiction_resolution"
...
def test_deepening_b_contradiction_resolution_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_contradiction_resolution_audit_demo_json_graph_and_report():
    module = m()
