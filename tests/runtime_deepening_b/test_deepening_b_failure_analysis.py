...
MODULE = "orchestration.runtime.deepening_b_failure_analysis"
...
def test_deepening_b_failure_analysis_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_failure_analysis_audit_demo_json_graph_and_report():
    module = m()
