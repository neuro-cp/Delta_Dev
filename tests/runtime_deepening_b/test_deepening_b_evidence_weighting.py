...
MODULE = "orchestration.runtime.deepening_b_evidence_weighting"
...
def test_deepening_b_evidence_weighting_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_evidence_weighting_audit_demo_json_graph_and_report():
    module = m()
