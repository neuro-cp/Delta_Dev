...
MODULE = "orchestration.runtime.deepening_b_multi_hop_planning"
...
def test_deepening_b_multi_hop_planning_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_multi_hop_planning_audit_demo_json_graph_and_report():
    module = m()
