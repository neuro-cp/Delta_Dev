...
MODULE = "orchestration.runtime.deepening_b_reasoning_validation"
...
def test_deepening_b_reasoning_validation_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_reasoning_validation_audit_demo_json_graph_and_report():
    module = m()
