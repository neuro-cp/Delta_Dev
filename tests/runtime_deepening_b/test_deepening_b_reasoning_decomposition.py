...
MODULE = "orchestration.runtime.deepening_b_reasoning_decomposition"
...
def test_deepening_b_reasoning_decomposition_objects_validation_and_safety():
    module = m()
...
def test_deepening_b_reasoning_decomposition_audit_demo_json_graph_and_report():
    module = m()
