...
MODULE = "orchestration.runtime.deepening_a_confidence_propagation"
...
def test_deepening_a_confidence_propagation_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_confidence_propagation_audit_demo_json_graph_and_report():
    module = m()
