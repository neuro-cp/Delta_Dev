...
MODULE = "orchestration.runtime.deepening_a_executive_planner"
...
def test_deepening_a_executive_planner_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_executive_planner_audit_demo_json_graph_and_report():
    module = m()
