...
MODULE = "orchestration.runtime.deepening_a_state_transitions"
...
def test_deepening_a_state_transitions_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_state_transitions_audit_demo_json_graph_and_report():
    module = m()
