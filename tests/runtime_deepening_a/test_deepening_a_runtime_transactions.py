...
MODULE = "orchestration.runtime.deepening_a_runtime_transactions"
...
def test_deepening_a_runtime_transactions_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_runtime_transactions_audit_demo_json_graph_and_report():
    module = m()
