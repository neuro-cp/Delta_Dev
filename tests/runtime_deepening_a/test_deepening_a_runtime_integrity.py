...
MODULE = "orchestration.runtime.deepening_a_runtime_integrity"
...
def test_deepening_a_runtime_integrity_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_runtime_integrity_audit_demo_json_graph_and_report():
    module = m()
