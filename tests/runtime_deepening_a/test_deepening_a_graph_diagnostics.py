...
MODULE = "orchestration.runtime.deepening_a_graph_diagnostics"
...
def test_deepening_a_graph_diagnostics_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_graph_diagnostics_audit_demo_json_graph_and_report():
    module = m()
