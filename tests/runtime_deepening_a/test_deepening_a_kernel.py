...
MODULE = "orchestration.runtime.deepening_a_kernel"
...
def test_deepening_a_kernel_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_kernel_audit_demo_json_graph_and_report():
    module = m()
