...
MODULE = "orchestration.runtime.deepening_a_pipeline_builder"
...
def test_deepening_a_pipeline_builder_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_pipeline_builder_audit_demo_json_graph_and_report():
    module = m()
