...
MODULE = "orchestration.runtime.deepening_a_lifecycle_manager"
...
def test_deepening_a_lifecycle_manager_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_lifecycle_manager_audit_demo_json_graph_and_report():
    module = m()
