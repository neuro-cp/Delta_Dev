...
MODULE = "orchestration.runtime.deepening_a_capability_registry"
...
def test_deepening_a_capability_registry_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_capability_registry_audit_demo_json_graph_and_report():
    module = m()
