...
MODULE = "orchestration.runtime.deepening_a_object_validation"
...
def test_deepening_a_object_validation_objects_validation_and_safety():
    module = m()
...
def test_deepening_a_object_validation_audit_demo_json_graph_and_report():
    module = m()
