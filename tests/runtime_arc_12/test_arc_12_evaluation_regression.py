...
MODULE_NAME = "orchestration.runtime.arc_12_evaluation_regression"
...
def test_arc_12_demo_and_report_payload_json_serializable():
    m = module()
...
def test_arc_12_write_report_outputs_review_only_artifacts():
    m = module()
