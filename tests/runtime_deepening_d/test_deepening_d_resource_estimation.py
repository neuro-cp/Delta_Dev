...
MODULE = "orchestration.runtime.deepening_d_resource_estimation"
...
def test_deepening_d_resource_estimation_objects_validation_and_safety():
    module = m()
...
def test_deepening_d_resource_estimation_audit_demo_json_graph_and_report():
    module = m()
