...
MODULE = "orchestration.runtime.deepening_d_cross_project_planning"
...
def test_deepening_d_cross_project_planning_objects_validation_and_safety():
    module = m()
...
def test_deepening_d_cross_project_planning_audit_demo_json_graph_and_report():
    module = m()
