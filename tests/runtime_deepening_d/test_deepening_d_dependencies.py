...
MODULE = "orchestration.runtime.deepening_d_dependencies"
...
def test_deepening_d_dependencies_objects_validation_and_safety():
    module = m()
...
def test_deepening_d_dependencies_audit_demo_json_graph_and_report():
    module = m()
