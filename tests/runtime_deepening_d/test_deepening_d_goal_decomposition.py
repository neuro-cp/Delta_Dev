...
MODULE = "orchestration.runtime.deepening_d_goal_decomposition"
...
def test_deepening_d_goal_decomposition_objects_validation_and_safety():
    module = m()
...
def test_deepening_d_goal_decomposition_audit_demo_json_graph_and_report():
    module = m()
