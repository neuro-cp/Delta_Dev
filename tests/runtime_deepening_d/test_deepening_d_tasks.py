...
MODULE = "orchestration.runtime.deepening_d_tasks"
...
def test_deepening_d_tasks_objects_validation_and_safety():
    module = m()
...
def test_deepening_d_tasks_audit_demo_json_graph_and_report():
    module = m()
