...
MODULE = "orchestration.runtime.deepening_d_portfolio"
...
def test_deepening_d_portfolio_objects_validation_and_safety():
    module = m()
...
def test_deepening_d_portfolio_audit_demo_json_graph_and_report():
    module = m()
