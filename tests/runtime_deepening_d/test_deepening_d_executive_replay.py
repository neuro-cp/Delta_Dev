...
MODULE = "orchestration.runtime.deepening_d_executive_replay"
...
def test_deepening_d_executive_replay_objects_validation_and_safety():
    module = m()
...
def test_deepening_d_executive_replay_audit_demo_json_graph_and_report():
    module = m()
